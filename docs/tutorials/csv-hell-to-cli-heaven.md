...
// Create CLI with auto-registered commands
const cli = createCLI({
  name: 'csv-processor',
  version: '1.0.0',
  description: 'Transform messy CSV data into clean output',
  commands: [versionCommand, helpCommand], // Commands are auto-registered
})
...
const cli = createCLI({
  ...
  version: '1.0.0',
  description: 'Transform messy CSV data into clean output',
-  commands: [versionCommand, helpCommand],
+  commands: [versionCommand, helpCommand, parseCommand],  // Add parseCommand here
})
...
const cli = createCLI({
  ...
  version: '1.0.0',
  description: 'Transform messy CSV data into clean output',
-  commands: [versionCommand, helpCommand, parseCommand],
+  commands: [versionCommand, helpCommand, parseCommand, transformCommand],  // Add transformCommand
})
...
const cli = createCLI({
  ...
  version: '1.0.0',
  description: 'Transform messy CSV data into clean output',
-  commands: [versionCommand, helpCommand, parseCommand, transformCommand],
+  commands: [versionCommand, helpCommand, parseCommand, transformCommand, validateCommand],  // Add validateCommand
})
