...
Check out the [documentation](_media/README.md)for comprehensive guides and API references.
...
| -------------------------------------- | -------------------- | ----------------------------------------------------------- |
| <a id="name"></a> `name`               | `string`             | CLI application name (used in help text and version output) |
| <a id="version"></a> `version`         | `string`             | Version string for the CLI application                      |
| <a id="description"></a> `description` | `string`             | Description shown in help text                              |
| <a id="commands"></a> `commands?`      | `Command`\<`any`\>[] | Array of commands to register with the CLI                  |
...
| --------- | ---------- | ------------------------------------------------- |
| `argv?`   | `string`[] | Command line arguments (defaults to process.argv) |
...
| Parameter | Type                      | Description              |
| --------- | ------------------------- | ------------------------ |
| `config`  | [`CLIConfig`](#cliconfig) | CLI configuration object |
