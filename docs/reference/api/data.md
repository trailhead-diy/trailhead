...
> **convertFormat**: (`data`, `targetFormat`) => `Result`\<`string`, [`CoreError`](@esteban-url.cli.md#coreerror)\>
...
`Result`\<`string`, [`CoreError`](@esteban-url.cli.md#coreerror)\>

Converted content string

##### detectFormat()

> **detectFormat**: (`filePath`) => [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`Result`\<`string`, [`CoreError`](@esteban-url.cli.md#coreerror)\>\>
...
[`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`Result`\<`string`, [`CoreError`](@esteban-url.cli.md#coreerror)\>\>

Detected MIME type

##### detectFormatFromContent()

> **detectFormatFromContent**: (`content`, `fileName?`) => `Result`\<`string`, [`CoreError`](@esteban-url.cli.md#coreerror)\>
...
> **writeAuto**: (`filePath`, `data`) => [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`Result`\<`void`, [`CoreError`](@esteban-url.cli.md#coreerror)\>\>
...
> **DataResult**\<`T`\> = `Result`\<`T`, [`CoreError`](@esteban-url.cli.md#coreerror)\>
...
> **FormatResult**\<`T`\> = `Result`\<`T`, [`CoreError`](@esteban-url.cli.md#coreerror)\>
...
> `const` **defaultExcelConfig**: [`Required`](https://www.typescriptlang.org/docs/handbook/utility-types.html#requiredtype)\<`Omit`\<[`ExcelConfig`](#excelconfig), `"worksheetName"` \| `"range"`\>\> & `Pick`\<[`ExcelConfig`](#excelconfig), `"worksheetName"` \| `"range"`\>
...
> `const` **defaultJSONConfig**: [`Required`](https://www.typescriptlang.org/docs/handbook/utility-types.html#requiredtype)\<`Omit`\<[`JSONConfig`](#jsonconfig), `"reviver"` \| `"replacer"` \| `"space"`\>\> & `Pick`\<[`JSONConfig`](#jsonconfig), `"reviver"` \| `"replacer"` \| `"space"`\>
...
> **createConversionError**(`message`, `options?`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **createCSVError**(`message`, `options?`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **createExcelError**(`message`, `options?`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **createFormatDetectionError**(`message`, `options?`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **createJSONError**(`message`, `options?`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **createParsingError**(`message`, `options?`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **createValidationError**(`message`, `options?`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **mapLibraryError**(`library`, `operation`, `error`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **mapNodeError**(`operation`, `path`, `error`): [`CoreError`](@esteban-url.cli.md#coreerror)
...
> **mapValidationError**(`field`, `value`, `error`): [`CoreError`](@esteban-url.cli.md#coreerror)
