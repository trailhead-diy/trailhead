...
> **generateProject**(`config`, `context`): [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`Result`\<`void`, [`CoreError`](@esteban-url.cli.md#coreerror)\>\>
...
> **validateConfig**(`config`): `Result`\<[`ProjectConfig`](#projectconfig), [`CoreError`](@esteban-url.cli.md#coreerror)\>
...
`Result`\<[`ProjectConfig`](#projectconfig), [`CoreError`](@esteban-url.cli.md#coreerror)\>
