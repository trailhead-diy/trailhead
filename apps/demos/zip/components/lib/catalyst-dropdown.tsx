...
export function CatalystDropdownItem({
  ...
  let classes = clsx(
    ...
    // Text styles
    'text-left text-base/6 text-base-950 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]',
    // Focus
    ...
    '*:data-[slot=icon]:text-base-500 data-focus:*:data-[slot=icon]:text-primary-foreground dark:*:data-[slot=icon]:text-base-400 dark:data-focus:*:data-[slot=icon]:text-primary-foreground',
    // Avatar
...
export function CatalystDropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm/5 font-medium text-base-500 sm:px-3 sm:text-xs/5 dark:text-base-400'
      )}
    />
  )
}
...
export function CatalystDropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-base-950/5 sm:mx-3 dark:bg-white/10 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function CatalystDropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-base-500 group-data-focus:text-primary-foreground sm:text-xs/5 dark:text-base-400 forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
    ...
    >
      {(Array.isArray(keys) ? keys : keys.split('')).map((char, index) => (
        <kbd
          key={index}
          className={clsx([
            'min-w-[2ch] text-center font-sans text-base-400 capitalize group-data-focus:text-primary-foreground forced-colors:group-data-focus:text-[HighlightText]',
