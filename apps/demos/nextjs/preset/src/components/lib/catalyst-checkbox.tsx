...
const base = [
  ...
  // Border
  'border border-base-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-base-950/30 group-data-checked:bg-(--checkbox-checked-border)',
  'dark:border-white/15 dark:group-data-checked:border-white/5 dark:group-data-hover:group-data-checked:border-white/5 dark:group-data-hover:border-white/30',
  // Inner highlight shadow
  'after:absolute after:inset-0 after:rounded-[calc(0.3125rem-1px)] after:shadow-[inset_0_1px_--theme(--color-white/15%)]',
  'dark:after:-inset-px dark:after:hidden dark:after:rounded-[0.3125rem] dark:group-data-checked:after:block',
  // Focus ring
  'group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-[var(--color-primary)]',
  // Disabled state
  'group-data-disabled:opacity-50',
  'group-data-disabled:border-base-950/25 group-data-disabled:bg-base-950/5 group-data-disabled:[--checkbox-check:var(--color-base-950)]/50 group-data-disabled:before:bg-transparent',
...
const colors = {
  ...
  primary:
    '[--checkbox-check:var(--color-primary-foreground)] [--checkbox-checked-bg:var(--color-primary)] [--checkbox-checked-border:var(--color-primary)]',
  secondary:
    '[--checkbox-check:var(--color-secondary-foreground)] [--checkbox-checked-bg:var(--color-secondary)] [--checkbox-checked-border:var(--color-secondary)]',
  destructive:
    '[--checkbox-check:var(--color-destructive-foreground)] [--checkbox-checked-bg:var(--color-destructive)] [--checkbox-checked-border:var(--color-destructive)]',
  success:
    '[--checkbox-check:var(--color-success-foreground)] [--checkbox-checked-bg:var(--color-success)] [--checkbox-checked-border:var(--color-success)]',
  warning:
    '[--checkbox-check:var(--color-warning-foreground)] [--checkbox-checked-bg:var(--color-warning)] [--checkbox-checked-border:var(--color-warning)]',
  info: '[--checkbox-check:var(--color-info-foreground)] [--checkbox-checked-bg:var(--color-info)] [--checkbox-checked-border:var(--color-info)]',
  // Specific color variants
  'dark/base': [
    '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-base-900)] [--checkbox-checked-border:var(--color-base-950)]/90',
    'dark:[--checkbox-checked-bg:var(--color-base-600)]',
  ],
  'dark/white': [
    '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-base-900)] [--checkbox-checked-border:var(--color-base-950)]/90',
    'dark:[--checkbox-check:var(--color-base-900)] dark:[--checkbox-checked-bg:var(--color-white)] dark:[--checkbox-checked-border:var(--color-base-950)]/15',
  ],
  white:
    '[--checkbox-check:var(--color-base-900)] [--checkbox-checked-bg:var(--color-white)] [--checkbox-checked-border:var(--color-base-950)]/15',
  dark: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-base-900)] [--checkbox-checked-border:var(--color-base-950)]/90',
  base: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-base-600)] [--checkbox-checked-border:var(--color-base-700)]/90',
