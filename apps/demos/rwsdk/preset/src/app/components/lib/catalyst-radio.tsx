...
const base = [
  ...
  // Border
  'border border-base-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-base-950/30 group-data-checked:bg-(--radio-checked-border)',
  ...
  '[--radio-indicator:transparent] group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:[--radio-indicator:var(--color-base-900)]/10',
  // Indicator color (dark mode)
  'dark:group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-hover:[--radio-indicator:var(--color-base-700)]',
  // Focus ring
  'group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-[var(--color-primary)]',
  // Disabled state
  'group-data-disabled:opacity-50',
  'group-data-disabled:border-base-950/25 group-data-disabled:bg-base-950/5 group-data-disabled:[--radio-checked-indicator:var(--color-base-950)]/50 group-data-disabled:before:bg-transparent',
...
const colors = {
  ...
  primary:
    '[--radio-checked-indicator:var(--color-primary-foreground)] [--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)]',
  secondary:
    '[--radio-checked-indicator:var(--color-secondary-foreground)] [--radio-checked-bg:var(--color-secondary)] [--radio-checked-border:var(--color-secondary)]',
  destructive:
    '[--radio-checked-indicator:var(--color-destructive-foreground)] [--radio-checked-bg:var(--color-destructive)] [--radio-checked-border:var(--color-destructive)]',
  success:
    '[--radio-checked-indicator:var(--color-success-foreground)] [--radio-checked-bg:var(--color-success)] [--radio-checked-border:var(--color-success)]',
  warning:
    '[--radio-checked-indicator:var(--color-warning-foreground)] [--radio-checked-bg:var(--color-warning)] [--radio-checked-border:var(--color-warning)]',
  info: '[--radio-checked-indicator:var(--color-info-foreground)] [--radio-checked-bg:var(--color-info)] [--radio-checked-border:var(--color-info)]',
  // Specific color variants
  'dark/base': [
    '[--radio-checked-bg:var(--color-base-900)] [--radio-checked-border:var(--color-base-950)]/90 [--radio-checked-indicator:var(--color-white)]',
    'dark:[--radio-checked-bg:var(--color-base-600)]',
  ],
  'dark/white': [
    '[--radio-checked-bg:var(--color-base-900)] [--radio-checked-border:var(--color-base-950)]/90 [--radio-checked-indicator:var(--color-white)]',
    'dark:[--radio-checked-bg:var(--color-white)] dark:[--radio-checked-border:var(--color-base-950)]/15 dark:[--radio-checked-indicator:var(--color-base-900)]',
  ],
  white:
    '[--radio-checked-bg:var(--color-white)] [--radio-checked-border:var(--color-base-950)]/15 [--radio-checked-indicator:var(--color-base-900)]',
  dark: '[--radio-checked-bg:var(--color-base-900)] [--radio-checked-border:var(--color-base-950)]/90 [--radio-checked-indicator:var(--color-white)]',
  base: '[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-base-600)] [--radio-checked-border:var(--color-base-700)]/90',
  red: '[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-destructive-600)] [--radio-checked-border:var(--color-destructive-700)]/90',
  orange:
