...
import { CatalystSwitch, CatalystSwitchGroup, CatalystSwitchField } from './lib/catalyst-switch'
...
export const Switch = ({ className, ...props }: SwitchProps) => {
  return <CatalystSwitch className={cn(className)} {...props} />
}

export const SwitchGroup = ({ className, children, ...props }: SwitchGroupProps) => (
  <CatalystSwitchGroup className={cn(className)} {...props}>
    {children}
  </CatalystSwitchGroup>
)

export const SwitchField = ({ className, children, ...props }: SwitchFieldProps) => (
