...
// export type DropdownButtonProps<T extends ElementType = 'button'> = ComponentProps<
//   typeof CatalystDropdownButton<T>
//>
...
export function DropdownButton<T extends React.ElementType>(props: DropdownButtonPropsWithAs<T>): JSX.Element
