...
// Type exports
export type ListboxProps<T = unknown> = ComponentProps<
  typeof CatalystListbox<T>
>;
export type ListboxOptionProps<T = unknown> = ComponentProps<
  typeof CatalystListboxOption<T>
>;
export type ListboxLabelProps = ComponentProps<typeof CatalystListboxLabel>;
export type ListboxDescriptionProps = ComponentProps<
  typeof CatalystListboxDescription
>;
