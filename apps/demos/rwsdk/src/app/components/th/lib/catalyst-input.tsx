      ...
      <Headless.Input
        ...
        className={cn(
          [
            ...
            // Disabled state
            'data-disabled:border-muted-foreground/20 dark:data-disabled:border-muted-foreground/20 dark:data-disabled:bg-muted dark:data-hover:data-disabled:border-muted-foreground/20',
            // System icons
            'dark:scheme-dark',
          ],
          resolvedStyles,
