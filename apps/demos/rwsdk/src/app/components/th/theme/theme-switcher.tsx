  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2">
        ...
        <Select value={currentTheme || 'zinc'} onChange={(e) => setTheme(e.target.value)} className="min-w-[120px]">
    ...
    <div className="z space-y-6 rounded-lg border border-border bg-card p-6">
      <div>
        ...
        <p className="mb-4 text-sm text-muted-foreground">
          Current theme: <span className="font-medium">{currentTheme}</span> ({isDark ? 'dark' : 'light'} mode)
        </p>
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <div className="h-8 w-8 rounded" style={{ backgroundColor: 'hsl(var(--chart-1))' }} title="Chart 1" />
          <div className="h-8 w-8 rounded" style={{ backgroundColor: 'hsl(var(--chart-2))' }} title="Chart 2" />
          <div className="h-8 w-8 rounded" style={{ backgroundColor: 'hsl(var(--chart-3))' }} title="Chart 3" />
          <div className="h-8 w-8 rounded" style={{ backgroundColor: 'hsl(var(--chart-4))' }} title="Chart 4" />
          <div className="h-8 w-8 rounded" style={{ backgroundColor: 'hsl(var(--chart-5))' }} title="Chart 5" />
        </div>
      </div>
    </div>
  )
