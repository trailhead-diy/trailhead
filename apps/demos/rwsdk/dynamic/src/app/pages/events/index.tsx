...
import { Dropdown, DropdownButton, DropdownItem, DropdownMenu } from '@/app/components/dropdown'
...
export default async function Events({ ctx }: RequestInfo) {
            ...
            <div className="flex items-center justify-between">
              <div key={event.id} className="flex gap-6 py-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="text-xs/6 text-base-500">
                    {event.date} at {event.time} <span aria-hidden="true">·</span> {event.location}
                  </div>
                  <div className="text-xs/6 text-base-600">
              ...
              <div className="flex items-center gap-4">
                <Badge
                  ...
                  color={event.status === 'On Sale' ? 'lime' : 'base'}
                >
                  {event.status}
                </Badge>
                <Dropdown>
