...
const colors = {
  ...
  primary: [
    '[--switch-bg-ring:var(--color-primary)] [--switch-bg:var(--color-primary)] dark:[--switch-bg-ring:transparent]',
    '[--switch:var(--color-primary-foreground)] [--switch-ring:var(--color-primary)] [--switch-shadow:var(--color-primary)]/20',
  ],
  secondary: [
    '[--switch-bg-ring:var(--color-secondary)] [--switch-bg:var(--color-secondary)] dark:[--switch-bg-ring:transparent]',
    '[--switch:var(--color-secondary-foreground)] [--switch-ring:var(--color-secondary)] [--switch-shadow:var(--color-secondary)]/20',
  ],
  destructive: [
    '[--switch-bg-ring:var(--color-destructive)] [--switch-bg:var(--color-destructive)] dark:[--switch-bg-ring:transparent]',
    '[--switch:var(--color-destructive-foreground)] [--switch-ring:var(--color-destructive)] [--switch-shadow:var(--color-destructive)]/20',
  ],
  success: [
    '[--switch-bg-ring:var(--color-success)] [--switch-bg:var(--color-success)] dark:[--switch-bg-ring:transparent]',
    '[--switch:var(--color-success-foreground)] [--switch-ring:var(--color-success)] [--switch-shadow:var(--color-success)]/20',
  ],
  warning: [
    '[--switch-bg-ring:var(--color-warning)] [--switch-bg:var(--color-warning)] dark:[--switch-bg-ring:transparent]',
    '[--switch:var(--color-warning-foreground)] [--switch-ring:var(--color-warning)] [--switch-shadow:var(--color-warning)]/20',
  ],
  info: [
    '[--switch-bg-ring:var(--color-info)] [--switch-bg:var(--color-info)] dark:[--switch-bg-ring:transparent]',
    '[--switch:var(--color-info-foreground)] [--switch-ring:var(--color-info)] [--switch-shadow:var(--color-info)]/20',
  ],
  // Specific color variants
  'dark/base': [
    '[--switch-bg-ring:var(--color-base-950)]/90 [--switch-bg:var(--color-base-900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:var(--color-white)]/25',
    '[--switch-ring:var(--color-base-950)]/90 [--switch-shadow:var(--color-black)]/10 [--switch:white] dark:[--switch-ring:var(--color-base-700)]/90',
  ],
  'dark/white': [
    '[--switch-bg-ring:var(--color-base-950)]/90 [--switch-bg:var(--color-base-900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:var(--color-white)]',
    '[--switch-ring:var(--color-base-950)]/90 [--switch-shadow:var(--color-black)]/10 [--switch:white] dark:[--switch-ring:transparent] dark:[--switch:var(--color-base-900)]',
  ],
  dark: [
    '[--switch-bg-ring:var(--color-base-950)]/90 [--switch-bg:var(--color-base-900)] dark:[--switch-bg-ring:var(--color-white)]/15',
    '[--switch-ring:var(--color-base-950)]/90 [--switch-shadow:var(--color-black)]/10 [--switch:white]',
  ],
  base: [
    '[--switch-bg-ring:var(--color-base-700)]/90 [--switch-bg:var(--color-base-600)] dark:[--switch-bg-ring:transparent]',
    '[--switch-shadow:var(--color-black)]/10 [--switch:white] [--switch-ring:var(--color-base-700)]/90',
  ],
  white: [
    '[--switch-bg-ring:var(--color-black)]/15 [--switch-bg:white] dark:[--switch-bg-ring:transparent]',
    '[--switch-shadow:var(--color-black)]/10 [--switch-ring:transparent] [--switch:var(--color-base-950)]',
  ],
  red: [
    '[--switch-bg-ring:var(--color-destructive-700)]/90 [--switch-bg:var(--color-destructive-600)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-destructive-700)]/90 [--switch-shadow:var(--color-destructive-900)]/20',
  ],
  orange: [
  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Unchecked
        'bg-base-200 ring-1 ring-black/5 ring-inset dark:bg-white/5 dark:ring-white/15',
        // Checked
        ...
        // Disabled
        'data-disabled:bg-base-200 data-disabled:opacity-50 data-disabled:data-checked:bg-base-200 data-disabled:data-checked:ring-black/5',
