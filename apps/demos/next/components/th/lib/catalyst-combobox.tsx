  ...
  return (
    ...
    >
        ...
        <Headless.ComboboxInput
          ...
          className={cn(
            [
              ...
              // Typography
              'text-base/6 text-foreground placeholder:text-zinc-500 sm:text-sm/6 dark:text-foreground',
              // Border
      ...
      <Headless.ComboboxOptions
        ...
        className={cn(
          // Anchor positioning
          '[--anchor-gap:--spacing(2)] [--anchor-padding:--spacing(4)] sm:data-[anchor~=start]:[--anchor-offset:-4px]', // Base styles,
          'isolate min-w-[calc(var(--input-width)+8px)] scroll-py-1 rounded-xl p-1 select-none empty:invisible', // Invisible border that is only visible in `forced-colors` mode for accessibility purposes
          'outline outline-transparent focus:outline-hidden', // Handle scrolling when menu won't fit in viewport
          'overflow-y-scroll overscroll-contain', // Popover background
