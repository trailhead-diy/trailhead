...
const base = [
  ...
  'dark:bg-card dark:group-data-checked:bg-(--checkbox-checked-bg)',
  // Border
  ...
  'dark:group-data-disabled:border-border dark:group-data-disabled:bg-card dark:group-data-disabled:[--checkbox-check:var(--color-background)]/50 dark:group-data-checked:group-data-disabled:after:hidden',
  // Forced colors mode
...
const colors = {
  ...
  primary:
    '[--checkbox-check:var(--primary-foreground)] [--checkbox-checked-bg:var(--primary)] [--checkbox-checked-border:var(--primary)]/90',
  secondary:
    '[--checkbox-check:var(--secondary-foreground)] [--checkbox-checked-bg:var(--secondary)] [--checkbox-checked-border:var(--secondary)]/90',
  accent:
