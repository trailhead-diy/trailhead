...
export function Description({
  ...
  return (
    <Headless.Description
      ...
      {...props}
      className={clsx(className, 'data-disabled:opacity-50 text-base/6 text-zinc-500 sm:text-sm/6 dark:text-zinc-400')}
    />
  )
}
...
export function ErrorMessage({
  ...
  return (
    <Headless.Description
      data-slot="error"
      {...props}
      className={clsx(className, 'data-disabled:opacity-50 text-base/6 text-red-600 sm:text-sm/6 dark:text-red-500')}
    />
  )
}
