...
export function validateGroups(
  ...
  // Allow empty groups array - this can happen when all files are excluded
  // or when there are no changes to process
...
export {
  ...
  determineAnalysisMode as detectComplexityMode,
}
