...
const authLayoutColorMappings = makeProtected([
    // Background patterns
    { pattern: /bg-white/, replacement: 'bg-background', description: 'Convert white to semantic background' },
    { pattern: /bg-zinc-50/, replacement: 'bg-muted/5', description: 'Convert light zinc to muted with opacity' },
    { pattern: /bg-zinc-100/, replacement: 'bg-muted/10', description: 'Convert zinc-100 to muted with opacity' },
    { pattern: /bg-zinc-900/, replacement: 'bg-background', description: 'Convert dark zinc to background' },
    { pattern: /bg-zinc-950/, replacement: 'bg-background', description: 'Convert darkest zinc to background' },
    ...
    // Dark mode patterns
    { pattern: /dark:bg-zinc-900/, replacement: 'dark:bg-background', description: 'Convert dark mode zinc bg to background' },
    { pattern: /dark:bg-zinc-950/, replacement: 'dark:bg-background', description: 'Convert darkest zinc bg to background' },
    { pattern: /dark:bg-white/, replacement: 'dark:bg-background', description: 'Convert dark mode white bg to background' },
    ...
    { pattern: /dark:border-white\/5/, replacement: 'dark:border-border', description: 'Convert dark mode light border to semantic' },

    // Ring colors
    { pattern: /ring-zinc-950\/10/, replacement: 'ring-ring', description: 'Convert zinc ring to semantic' },
    { pattern: /ring-white\/10/, replacement: 'ring-ring', description: 'Convert white ring to semantic' },

    // Focus states
    { pattern: /focus:ring-zinc-950/, replacement: 'focus:ring-ring', description: 'Convert focus zinc ring to semantic' },
    { pattern: /focus:ring-white/, replacement: 'focus:ring-ring', description: 'Convert focus white ring to semantic' },

    // Shadow colors
    { pattern: /shadow-zinc-950\/5/, replacement: 'shadow-border/20', description: 'Convert zinc shadow to semantic border shadow' },
])
