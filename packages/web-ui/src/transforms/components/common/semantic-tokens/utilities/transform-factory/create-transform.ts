...
import { updateColorTypeAlias, updateColorPropType, addColorPropToInterface, addPropsToInlineType } from '../type-updater.js'
...
import { shouldTransformContent, findComponentDeclaration, extractFunctionBody, getFunctionParams } from './component-detector.js'
...
function processComponentDeclaration(
  ...
  const { name, variableName = 'resolvedColorClasses', defaultColor, useIIFE, hasColorsObject } = config
