...
const headingColorMappings = makeProtected([
    ...
    { pattern: /text-zinc-800/, replacement: 'text-foreground', description: 'Convert zinc-800 text to foreground' },
    { pattern: /text-zinc-700/, replacement: 'text-foreground/90', description: 'Convert zinc-700 text to foreground with opacity' },
    ...
    { pattern: /dark:text-zinc-100/, replacement: 'dark:text-foreground', description: 'Convert dark mode light zinc text to foreground' },
    { pattern: /dark:text-zinc-200/, replacement: 'dark:text-foreground/90', description: 'Convert dark mode zinc-200 text to foreground with opacity' },
    { pattern: /dark:text-zinc-400/, replacement: 'dark:text-muted-foreground', description: 'Convert dark mode zinc text to muted' },

    // Subheading/secondary text
    { pattern: /text-zinc-500/, replacement: 'text-muted-foreground', description: 'Convert zinc-500 subheading to muted' },
    { pattern: /text-zinc-600/, replacement: 'text-muted-foreground', description: 'Convert zinc-600 subheading to muted' },
    { pattern: /dark:text-zinc-400/, replacement: 'dark:text-muted-foreground', description: 'Convert dark mode zinc subheading to muted' },
])
