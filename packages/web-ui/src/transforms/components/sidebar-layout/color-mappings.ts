/**
 * Color mapping transform for SidebarLayout component
 ...
 */
export const sidebarLayoutColorMappingsTransform = createProtectedRegexTransform({
  name: 'sidebar-layout-color-mappings',
  description: 'Transform sidebar layout backdrop, backgrounds, and ring colors to semantic tokens',
  mappings: sidebarLayoutColorMappings,
