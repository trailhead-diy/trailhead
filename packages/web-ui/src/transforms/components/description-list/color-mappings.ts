...
const descriptionListColorMappings = makeProtected([
  // Background colors
  {
    ...
    description: 'Convert light zinc bg to muted',
  },
  {
    pattern: /bg-zinc-100/,
    replacement: 'bg-muted/10',
    description: 'Convert zinc-100 bg to muted',
  },
  {
    pattern: /bg-zinc-950\/5/,
    replacement: 'bg-muted/5',
    description: 'Convert zinc bg with opacity to muted',
  },
  {
    pattern: /bg-white/,
    replacement: 'bg-background',
    description: 'Convert white bg to background',
  },
  ...
  {
    pattern: /border-zinc-950\/5/,
    replacement: 'border-border/50',
    description: 'Convert light zinc border to semantic with opacity',
  },

  // Divide colors
  {
    pattern: /divide-zinc-200/,
    replacement: 'divide-border',
    description: 'Convert zinc divide to border',
  },
  {
    pattern: /divide-zinc-100/,
    replacement: 'divide-border/50',
    description: 'Convert light zinc divide to border with opacity',
  },
  {
    pattern: /divide-zinc-950\/5/,
    replacement: 'divide-border/50',
    description: 'Convert zinc divide with opacity to border',
  },
  ...
  },
  {
    ...
    replacement: 'dark:bg-muted/10',
    description: 'Convert dark mode zinc bg to muted',
  },
  {
    pattern: /dark:bg-white\/5/,
    replacement: 'dark:bg-muted/5',
    description: 'Convert dark mode white bg to muted',
  },
  {
  ...
  },
  {
    ...
    description: 'Convert dark mode light border to semantic with opacity',
  },
  {
    pattern: /dark:divide-white\/10/,
    replacement: 'dark:divide-border',
    description: 'Convert dark mode white divide to border',
  },
  {
    pattern: /dark:divide-white\/5/,
