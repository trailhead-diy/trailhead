...
import { createCommand, executeSubprocess, type CommandOptions } from '@trailhead/cli/command'

// ============================================================================
// TYPES
// ============================================================================

interface ProfileOptions extends CommandOptions {
  pipeline?: boolean
  simple?: boolean
  memory?: boolean
}
 ...
 */
export const createProfileCommand = (context: { projectRoot: string }) => {
