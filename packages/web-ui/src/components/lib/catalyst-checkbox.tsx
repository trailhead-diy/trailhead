...
import { isSemanticToken, createSemanticCheckboxStyles } from '../theme/semantic-tokens.js';
...
const base = [
  ...
  'dark:bg-background/$1 dark:group-data-checked:bg-(--checkbox-checked-bg)',
  // Border
  ...
  'dark:group-data-disabled:border-border dark:group-data-disabled:bg-background/$1 dark:group-data-disabled:[--checkbox-check:var(--color-background)]/50 dark:group-data-checked:group-data-disabled:after:hidden',
  // Forced colors mode
