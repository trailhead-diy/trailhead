...
This directory contains detailed color mapping documentation for Catalyst UI components, showing how colors are used semantically within each component.
...
4. **Color Table** - Comprehensive mapping of all color schemes
5. **CSS Custom Properties** - List of all CSS variables used

## Available Components

- [Button](./button.md) - Button component color mapping
...
- Theme customization
- Migration to Trailhead UI's semantic color system
