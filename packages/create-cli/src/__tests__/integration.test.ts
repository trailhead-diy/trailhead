...
describe('End-to-End Project Generation', () => {
  ...
  it('should generate valid package.json with correct dependencies', () => {
    ...
    expect(packageJson.dependencies).toHaveProperty('@trailhead/config')
    expect(packageJson.dependencies).toHaveProperty('@trailhead/fs')
    expect(packageJson.dependencies).toHaveProperty('@trailhead/validation')
