...
This smart git hooks system was generated by [@trailhead/trailhead-cli](https://github.com/trailhead-diy/trailhead) v{{CLI_VERSION}}.

For updates and more information, visit the [Trailhead CLI documentation](https://github.com/trailhead-diy/trailhead).
