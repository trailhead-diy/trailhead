...
export interface CSVStreamingOperations {
  ...
  readonly parseStringStream: (data: string, options?: StreamingCSVConfig) => StreamResult<Readable>
...
export interface JSONStreamingOperations {
  ...
  readonly parseArrayStream: (data: string, options?: StreamingJSONConfig) => StreamResult<Readable>
  readonly writeFileStream: (
    filePath: string,
    options?: StreamingJSONConfig
  ) => StreamResult<Writable>
