...
related:
  ...
  - ./reference/api.md
  - ./explanation/result-patterns.md
---
...
- [File Operations](./how-to/file-operations.md) - Common filesystem tasks
...
- [Result Patterns](./explanation/result-patterns.md) - Error handling design
