...
import { createTestTempDir, cleanup, createTestStructure } from './test-utils.js';
...
describe('FileSystem Performance Benchmarks', () => {
  ...
  describe('Read Performance', () => {
    it('should read small files efficiently', async () => {
      ...
      console.log(`Small file read: ${avgMs.toFixed(2)}ms average (${iterations} iterations)`);
    ...
    it('should read medium files efficiently', async () => {
      ...
      console.log(`Medium file read: ${avgMs.toFixed(2)}ms average (${iterations} iterations)`);
    ...
    it('should read large files within reasonable time', async () => {
      ...
      console.log(`Large file read: ${avgMs.toFixed(2)}ms average (${iterations} iterations)`);
  ...
  describe('Write Performance', () => {
    it('should write files efficiently', async () => {
      ...
      console.log(`File write: ${avgMs.toFixed(2)}ms average (${iterations} iterations)`);
  ...
  describe('Directory Operations Performance', () => {
    it('should create directories efficiently', async () => {
      ...
      console.log(`Directory creation: ${avgMs.toFixed(2)}ms average (${iterations} iterations)`);
    ...
    it('should read directories efficiently', async () => {
      ...
      console.log(`Directory read (${fileCount} files): ${avgMs.toFixed(2)}ms average`);
      expect(avgMs).toBeLessThan(50);
    });
  });
  ...
  describe('Memory vs Node FS Performance Comparison', () => {
    it('should compare read performance between implementations', async () => {
      ...
      const memoryAvg = Number(memoryEnd - memoryStart) / 1_000_000 / iterations;
  ...
  describe('Bulk Operations Performance', () => {
    it('should handle bulk copy operations efficiently', async () => {
      ...
      console.log(`Bulk copy (${fileCount} files): ${avgMs.toFixed(2)}ms average per file`);
      expect(avgMs).toBeLessThan(100);
    });
    ...
    it('should handle bulk remove operations efficiently', async () => {
      ...
      console.log(`Bulk remove (${fileCount} files): ${avgMs.toFixed(2)}ms average per file`);
      expect(avgMs).toBeLessThan(50);
    });
  });
});
