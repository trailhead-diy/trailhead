...
describe('Domain Validators', () => {
  describe('Framework Validation', () => {
    it('should accept valid framework types', () => {
      ...
      const validFrameworks: Framework[] = ['redwood-sdk', 'nextjs', 'vite', 'generic-react']
  ...
  describe('Semantic Version Validation', () => {
    it('should parse valid semantic versions', () => {
      const versions = [
        ...
        { input: '1.2.3+build123', expected: { major: 1, minor: 2, patch: 3, build: 'build123' } },
        { input: '1.2.3-beta.1+build', expected: { major: 1, minor: 2, patch: 3, prerelease: 'beta.1', build: 'build' } },
      ]
